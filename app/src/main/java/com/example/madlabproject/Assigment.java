        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    Toast.makeText(Assigment.this,"Error. enter the course code.",Toast.LENGTH_SHORT).show();
                }
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    ...
                    Toast.makeText(Assigment.this,"Editing assignment successful.",Toast.LENGTH_SHORT).show();
                    asssing_courseıd.setText("");
                    assing_name.setText("");
                    assing_content.setText("");
                    deudate.setText(" ");
