        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    Toast.makeText(Post.this,"Error. Enter the course code.",Toast.LENGTH_SHORT).show();
                }
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    ...
                    if (succes==false){
                        ...
                        Toast.makeText(Post.this,"Deleting post unsuccessful.",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
