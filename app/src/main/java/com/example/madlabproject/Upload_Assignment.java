        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    Toast.makeText(Upload_Assignment.this,"Error. Enter the correct course code.",Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText(Upload_Assignment.this,"Upload successful.",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
