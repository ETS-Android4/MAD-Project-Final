        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    Toast.makeText(Announcment.this,"Error. Enter the course code.",Toast.LENGTH_SHORT).show();
                }
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    ...
                    if (succes==false){
                        ...
                        Toast.makeText(Announcment.this,"Deleting announcement failed.",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
