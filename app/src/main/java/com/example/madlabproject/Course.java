        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    Toast.makeText(Course.this,"Error. Enter the course code.",Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(y)){
                    Toast.makeText(Course.this,"Error. Enter the first student's USN.",Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(z)){
                    Toast.makeText(Course.this,"Error. Enter the second student's USN.",Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(w)){
                    Toast.makeText(Course.this,"Error. Enter the third student's USN.",Toast.LENGTH_SHORT).show();
                }
                else{
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    ...
                    if (succes==false){
                        ...
                        Toast.makeText(Course.this,"Deleting course unsuccessful.",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
