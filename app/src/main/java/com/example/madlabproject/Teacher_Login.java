        ...
        log_teacher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(x)){
                    Toast.makeText(Teacher_Login.this,"Error. Enter the Faculty ID.",Toast.LENGTH_SHORT).show();
                }
                    ...
                    {
                        Toast.makeText(Teacher_Login.this,"There is no Faculty with this ID.",Toast.LENGTH_SHORT).show();
                    }
                }
